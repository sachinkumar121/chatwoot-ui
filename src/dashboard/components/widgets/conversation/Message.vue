<script>
import { useMessageFormatter } from '@/sharedcomposables/useMessageFormatter';
...
import { CONTENT_TYPES } from '@/sharedconstants/contentType';
import { MESSAGE_TYPE, MESSAGE_STATUS } from '@/sharedconstants/messages';
