...
import FooterReplyTo from '@/components/FooterReplyTo.vue';
import ChatInputWrap from '@/components/ChatInputWrap.vue';
import { BUS_EVENTS } from '@/shared/constants/busEvents';
import { sendEmailTranscript } from '@/api/conversation';
